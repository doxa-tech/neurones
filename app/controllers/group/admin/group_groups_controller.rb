...
class Group::Admin::GroupGroupsController < Admin::BaseController
  ...
  layout 'group/admin'
    ...
    if @group.save
      ...
      redirect_to group_admin_group_groups_path
    else
      render 'new' 
    end
  end
  ...
  def activate
    ...
    if @group.save
      ...
      redirect_to edit_group_admin_group_group_path(@group.id)
    else
      render 'activation'
    end
  end
